  ...
  },
  {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          "Yes — 32 languages are currently supported: English, Bengali, Hindi, Urdu, Chinese (Simplified and Traditional), Japanese, Korean, French, German, Spanish, Portuguese, Italian, Russian, Turkish, Dutch, Polish, Vietnamese, Greek, Hebrew, Thai, Tamil, Telugu, Kannada, Malayalam, Gujarati, Punjabi, Odia, Burmese, Georgian, and Khmer. Pick a language before extracting for the most reliable result, or use Auto-detect as a convenience — auto-detect works well on images with a reasonable amount of text, but for a single word or short label, picking the language directly is more reliable, since some languages share a script that can't be told apart automatically (e.g. Latin script alone can't distinguish English from French or German). More languages may be added over time as they're verified against the OCR engine.",
      },
    ],
  },
